import type { __experimental_CheckoutProps, __internal_UserVerificationProps, Appearance, Clerk, ClerkOptions, EnvironmentResource, SignInProps, SignUpProps, UserProfileProps, WaitlistProps } from '@clerk/types';
...
export type ComponentControls = {
    ...
    openDrawer: <T extends 'checkout'>(drawer: T, props: T extends 'checkout' ? __experimental_CheckoutProps : never) => void;
    closeDrawer: (drawer: 'checkout', options?: {
        notify?: boolean;
    }) => void;
