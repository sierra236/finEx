...
declare const applyVariants: (props?: {} | undefined) => (theme: import("../foundations").InternalTheme<Readonly<{
...
export declare const Table: React.ForwardRefExoticComponent<Omit<TableProps, "ref"> & React.RefAttributes<HTMLTableCellElement>>;
export {};
